 ...
 * This file demonstrates how to integrate Nexusmeld with a web frontend
 */

// For React/Vue/Angular applications
export class NexusmeldClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NexusmeldClient(provider, contractAddress);
